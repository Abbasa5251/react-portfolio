			...
			<div className="container pt-5">
				<div className="row align-items-center">
					<div className="left col-md-6">
						...
						<p className="mb-1">
							I am a{" "}
							<span className="tag-primary">UX/UI Designer</span>{" "}
							and{" "}
							<span className="tag-primary">Web Developer</span>.
							I am Studying in VPASC College, Baramati and
							pursuing Bachelor's degree in Computer Science. I
							have knowledge in many Programming and Scripting
							Languages such as{" "}
