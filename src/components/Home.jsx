				...
				<div className="row">
					...
					<div className="col-md-6 right pt-3 mt-3">
						...
						<h1 className="mt-1 title">
							I'm a Web{" "}
							<span className="tag-primary">Developer</span>
						</h1>
						<p className="mt-2 myDescription">
							I'am a Professional Web{" "}
							<span className="tag-pure">Designer</span> and{" "}
							<span className="tag-pure">Developer</span> and{" "}
							<span className="tag-pure">Python Programmer</span>.
